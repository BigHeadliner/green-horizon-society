!function(global, factory) {
    ...
    return (() => {
        ...
        const n = (e, t = {}) => {
            ...
            if ("stop" === n) o(e); else if (o(e), /[0-9]/.test(e.innerHTML)) {
                const l = r(e.innerHTML, {
                    duration: i || e.getAttribute("data-duration"),
                    delay: u || e.getAttribute("data-delay")
                }), c = (e._countUpOrigInnerHTML = e.innerHTML, e.innerHTML = l[0] || "&nbsp;", 
                e.style.visibility = "visible", function() {
                    e.innerHTML = l.shift() || "&nbsp;", l.length ? (clearTimeout(e.countUpTimeout), 
                    e.countUpTimeout = setTimeout(c, u)) : e._countUpOrigInnerHTML = void 0;
                });
                e.countUpTimeout = setTimeout(c, u);
            }
        }, o = e => {
            clearTimeout(e.countUpTimeout), e._countUpOrigInnerHTML && (e.innerHTML = e._countUpOrigInnerHTML, 
            e._countUpOrigInnerHTML = void 0), e.style.visibility = "";
        }, r = (e, t = {}) => {
            const {
                duration: n = 1e3,
                delay: o = 16
            ...
            for (let e = 0; e < i.length; e++) if (/([0-9.][,.0-9]*[0-9]*)/.test(i[e]) && !/<[^>]+>/.test(i[e])) {
                ...
                for (let e = r; 1 <= e; e--) {
                    ...
                    i = n.reduce((e, {
                        char: t,
                        i: n
                    }) => e.length <= n ? e : e.slice(0, -n) + t + e.slice(-n), i.toString()), 
                    u[o--] += i;
                }
    ...
    return e = [ function(e, t, n) {
        ...
        var i = Object.assign || function(e) {
            ...
            return e;
        }, a = (o(n(1)), n(6)), u = o(a), s = o(n(7)), d = o(n(8)), p = o(n(9)), b = o(n(10)), y = o(n(11)), h = o(n(14)), w = [], k = !1, x = {
            offset: 120,
            delay: 0,
            easing: "ease",
            duration: 400,
            ...
            if (k = 0 < arguments.length && void 0 !== arguments[0] && arguments[0] ? !0 : k) return w = (0, 
            y.default)(w, x), (0, b.default)(w, x.once), w;
        };
        e.exports = {
            init: function(e) {
                ...
                }(x.disable) || e ? void w.forEach(function(e, t) {
                    e.node.removeAttribute("data-aos"), e.node.removeAttribute("data-aos-easing"), 
                    e.node.removeAttribute("data-aos-duration"), e.node.removeAttribute("data-aos-delay");
                ...
                "DOMContentLoaded" === x.startEvent && -1 < [ "complete", "interactive" ].indexOf(document.readyState) ? j(!0) : ("load" === x.startEvent ? window : document).addEventListener(x.startEvent, function() {
                    j(!0);
        ...
        !function(t) {
            ...
            function n(e, t, n) {
                ...
                return t = u(t) || 0, i(n) && (M = !!n.leading, S = "maxWait" in n, 
                y = S ? x(u(n.maxWait) || 0, t) : y, _ = "trailing" in n ? !!n.trailing : _), 
                m.cancel = function() {
            ...
            function u(e) {
                ...
                if (a(e)) return f;
                if ("string" != typeof (e = i(e) ? i(t = "function" == typeof e.valueOf ? e.valueOf() : e) ? t + "" : t : e)) return 0 === e ? e : +e;
                e = e.replace(l, "");
                var t = m.test(e);
                return t || b.test(e) ? v(e.slice(2), t ? 2 : 8) : p.test(e) ? f : +e;
            }
            var c = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
                return typeof e;
            } : function(e) {
                return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e;
            }, s = "Expected a function", f = NaN, l = /^\s+|\s+$/g, p = /^[-+]0x[0-9a-f]+$/i, m = /^0b[01]+$/i, b = /^0o[0-7]+$/i, v = parseInt, t = "object" == (void 0 === t ? "undefined" : c(t)) && t && t.Object === Object && t, g = "object" == ("undefined" == typeof self ? "undefined" : c(self)) && self && self.Object === Object && self, h = t || g || Function("return this")(), k = Object.prototype.toString, x = Math.max, j = Math.min, O = function() {
                return h.Date.now();
            };
        ...
        !function(t) {
            ...
            function a(e) {
                ...
                e = e.replace(d, "");
                var t = p.test(e);
                return t || m.test(e) ? b(e.slice(2), t ? 2 : 8) : l.test(e) ? s : +e;
            }
            function j() {
                return g.Date.now();
            }
            var u = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
                ...
                return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e;
            }, s = NaN, f = "[object Symbol]", d = /^\s+|\s+$/g, l = /^[-+]0x[0-9a-f]+$/i, p = /^0b[01]+$/i, m = /^0o[0-7]+$/i, b = parseInt, t = "object" == (void 0 === t ? "undefined" : u(t)) && t && t.Object === Object && t, y = "object" == ("undefined" == typeof self ? "undefined" : u(self)) && self && self.Object === Object && self, g = t || y || Function("return this")(), w = Object.prototype.toString, k = Math.max, x = Math.min;
            e.exports = function(e, t, n) {
                ...
                return t = a(t) || 0, o(n) && (M = !!n.leading, S = "maxWait" in n, 
                y = S ? k(a(n.maxWait) || 0, t) : y, _ = "trailing" in n ? !!n.trailing : _), 
                m.cancel = function() {
        ...
        function a(e) {
            e && e.forEach(function(e) {
                ...
                if (function n(e) {
                    for (var o, t = void 0, t = 0; t < e.length; t += 1) {
        ...
        t.default = function(e, t) {
            ...
            return n + (o = a.anchorPlacement || a.offset || isNaN(t) ? o : t);
        };
    }, function(e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
    ...
    const hamburger = document.getElementById("menu__btn"), headerMenu = document.getElementById("menu__list"), menuLinks = document.querySelectorAll(".menu__link");
    ...
    hamburger.addEventListener("click", () => {
        headerMenu.classList.toggle("menu__list--active"), hamburger.classList.toggle("menu__btn--open");
    }), menuLinks.forEach(link => {
        link.addEventListener("click", () => {
            headerMenu.classList.remove("menu__list--active"), hamburger.classList.remove("menu__btn--open");
        });
    ...
    }), initMagnificPopup(""), initMagnificPopup("1");
    const counterUp = window.counterUp.default;
    var callback = entries => {
        entries.forEach(entry => {
            const el = entry.target;
            entry.isIntersecting && !el.classList.contains("is-visible") && (counterUp(el, {
                duration: 2e3,
                delay: 16
    ...
    const IO1 = new IntersectionObserver(callback, {
        threshold: 1
    }), IO2 = new IntersectionObserver(callback, {
        threshold: 1
    }), IO3 = new IntersectionObserver(callback, {
        threshold: 1
    });
    var callback = document.querySelector(".journey__number-title1"), el2 = document.querySelector(".journey__number-title2"), el3 = document.querySelector(".journey__number-title3");
    IO1.observe(callback), IO2.observe(el2), IO3.observe(el3), $(".donation__tabs-item ").on("click", function(e) {
        e.preventDefault(), $(".donation__tabs-item ").removeClass("donation__tabs-item--active"), 
        $(this).addClass("donation__tabs-item--active"), $(".donation__tabs-content").removeClass("donation__tabs-content--active"), 
        $($(this).attr("href")).addClass("donation__tabs-content--active");
    });
    let animationExecuted = !1;
    AOS.init({
        duration: 1700
    }), document.addEventListener("scroll", function() {
        var yourElement = document.querySelector(".your-element");
        window.scrollY > yourElement.offsetTop && !animationExecuted && (AOS.refreshHard(), 
        AOS.init(), animationExecuted = !0);
    });
});