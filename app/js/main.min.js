!function(global, factory) {
    ...
    }), popupId = "", $("#openPopupBtn" + popupId).magnificPopup({
        items: {
            src: "#myModal" + popupId,
            type: "inline"
        },
    ...
    const IO1 = new IntersectionObserver(popupId, {
        threshold: 1
    }), IO2 = new IntersectionObserver(popupId, {
        threshold: 1
    }), IO3 = new IntersectionObserver(popupId, {
        threshold: 1
    });
    var popupId = document.querySelector(".journey__number-title1"), el2 = document.querySelector(".journey__number-title2"), el3 = document.querySelector(".journey__number-title3");
    IO1.observe(popupId), IO2.observe(el2), IO3.observe(el3);
});